...
import (
	...
	"github.com/globe-and-citizen/Go-Wasm-To-Layer8-To-DB/go-layer8-slaves/layer8-slave-one/middleware"
	router "github.com/globe-and-citizen/Go-Wasm-To-Layer8-To-DB/go-layer8-slaves/layer8-slave-one/router"
...
func main() {
	...
	serverPort := os.Getenv("LAYER8_SLAVE_ONE_PORT")
